...
test_that("Complete pipeline: original database self-validation", {
  ...
  input <- threatenedperu:::threatenedperu$scientific_name |> unique()
...
test_that("Complete pipeline: updated database validation", {
  ...
  input <- threatenedperu:::threatenedperu_syn$accepted_name |>
    unique() |>
...
test_that("Complete pipeline: both databases have consistent categories", {
  ...
  data_orig <- threatenedperu:::threatenedperu
  ...
  data_upd <- threatenedperu:::threatenedperu_syn
