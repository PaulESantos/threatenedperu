...
[![Codecov test
coverage](https://codecov.io/gh/PaulESantos/threatenedperu/branch/main/graph/badge.svg)](https://app.codecov.io/gh/PaulESantos/threatenedperu?branch=main)
<!-- badges: end -->

## Overview

**threatenedperu** provides comprehensive tools for working with Peru’s
...
- **Hierarchical matching pipeline**: Direct → Genus → Fuzzy → Suffix
  matching
- **Handles taxonomic complexity**: Supports up to quaternomial names
  (Rank 4)
...
- **Synonym resolution**: Links historical names to accepted names
  automatically
- **Protection continuity**: Legal status maintained regardless of
...
**Key characteristics:** - 777+ species as listed in 2006 - Supports
quaternomial names (Rank 4) - Includes both accepted names and
synonyms - Original infraspecific rank formatting
...
Supports trinomial names (Rank 3 maximum) - Only accepted names
(synonyms resolved) - Updated to 2025 nomenclature
...
Date: July 13, 2006  
Legal basis: Articles 60°, 61°, 95°, 98° of Ley Forestal y de Fauna
Silvestre (Law No. 27308)
...
3.  **Species Match** (Nodes 4-5)
    ...
    - Suffix matching (handles Latin name variations: -a, -i, -is, -um,
      -us, -ae)
