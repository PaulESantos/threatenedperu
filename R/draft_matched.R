# splist <- c("Persea",
#             "Rauhia decora",
#             "Begonia octopetala var. ovatoformis",
#             "Begonia octopetala subsp. ovatoformis",
#             "Begonia octopetala subsp. ovatoformes",
#             "Haageocereus acranthus subsp. olowinskianus forma clavispinus",
#             "Haageocereus acranthus subsp. olowinskianus forma clavispinas"
# )
#
# target_df = "original"
# matching_threatenedperu(splist)
#
...
#     required_cols <- c("genus", "species", "infraspecies",
...
#
#   # ========================================================================
#   # VALIDACIÓN: Detectar Rank 4 cuando database no lo soporta
#   # ========================================================================
#
...
#   # ========================================================================
#     # Combine Matched Results from All Nodes
#
...
#   # =============================================================================
#   # This validation ensures that the matched taxonomic information is consistent
#   # with the original declared rank of the species query.
#   #
#   # Rank definitions:
#   #   Rank 1: Genus only
#   #   Rank 2: Genus + species (binomial)
#   #   Rank 3: Genus + species + infraspecies level 1 (trinomial)
#   #   Rank 4: Genus + species + infraspecies level 1 + level 2 (quaternomial)
#   # =============================================================================
#
#   combined <- combined |>
#     dplyr::mutate(
...
#   # =============================================================================
#   # Keep only records where the matched rank is consistent with declared rank
#   # =============================================================================
#
#   matched <- combined |>
...
#
#   # =============================================================================
#   # Identify Invalid Matches (Optional Diagnostic)
#   # =============================================================================
#   # These are cases where matching occurred but the rank is inconsistent
...
#
#   # ---------------------------------------------------------------
#   # NODE 6-A: Infraspecies Category Matching - Direct Match
#   # ---------------------------------------------------------------
#   Node_6_input <- unmatched |>
#     dplyr::filter(
#       !is.na(Orig.Infra.Rank),
#       !is.na(Matched.Genus),  # Debe tener genero matcheada
#       !is.na(Matched.Species),  # Debe tener especie matcheada
#       is.na(Matched.Infraspecies) # no tener direct match de infraespecie
#     )
#
#
...
#
#   # ---------------------------------------------------------------
#   # NODE 6-B: Infraspecies Fuzzy Matching
#   # ---------------------------------------------------------------
#
...
#     dplyr::filter(fuzzy_match_infraspecies == TRUE,
#                   Rank == 3 )
#
...
#                                   Node_6b_TRUE, # Fuzzy match at infraespecific level 3
#                                   Node_7_TRUE # Fuzzy match at infraespecific level 4
#                                   )
#     unmatched_f <- dplyr::bind_rows(Node_6a_FALSE, # unmatched at infrarank level
#                                     Node_7_FALSE)  # Unmatched at 4 level
#     # Unir con no-matches
...
#
#     res <- dplyr::bind_rows(matched_f,
#                             Node_6b_FALSE, # unmatched at infrarank level 3
#                             .id = 'matched') |>
#       dplyr::mutate(matched = (matched == 1))
#   }
#
...
#       ) |>
#       dplyr::distinct(genus, species, tag, infraspecies,
#                       infraspecies_2, .keep_all = TRUE)
#
#     output <- res_complete |>
...
#       output_f$Matched.Infraspecies_2[
#         !is.na(output_f$Matched.Rank) &
...
#         Matched.Rank == 4 &
#           !is.na(Matched.Infra.Rank) &
#           !is.na(Matched.Infra.Rank_2) ~ paste(
#           str_to_simple_cap(Matched.Genus),
#           stringr::str_to_lower(Matched.Species),
#           stringr::str_to_lower(Matched.Infra.Rank),
#           stringr::str_to_lower(Matched.Infraspecies),
